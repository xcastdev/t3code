...
/** A restoration approval must retain a complete, current source snapshot. */
export function branchRestoreMutationPrecondition(input: {
  readonly status: Pick<VcsStatusResult, "headCommit" | "indexTree" | "refName"> | null;
