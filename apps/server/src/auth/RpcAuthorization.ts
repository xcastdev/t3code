...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.skillsDeploymentList]: AuthOrchestrationReadScope,
  [WS_METHODS.skillsDeploymentChange]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.managedTextResourcesCatalogList]: AuthOrchestrationReadScope,
  [WS_METHODS.managedTextResourcesCatalogSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.managedTextResourcesContentGet]: AuthOrchestrationReadScope,
  [WS_METHODS.managedTextResourcesEnvironmentCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesEnvironmentUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesEnvironmentDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesEnvironmentSetEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesProjectSetOverride]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesProjectSetDisabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesProjectDeleteState]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesThreadSetEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.managedTextResourcesThreadReset]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.issuesSearch]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.projectWorkRead]: AuthOrchestrationReadScope,
  [WS_METHODS.projectWorkSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.projectWorkWrite]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectWorkRequestApproval]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectLifecycleArchive]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectLifecycleGet]: AuthOrchestrationReadScope,
  [WS_METHODS.projectLifecycleRestore]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectLifecycleRelocationCheck]: AuthOrchestrationReadScope,
  [WS_METHODS.projectLifecyclePermanentDelete]: AuthOrchestrationOperateScope,
