...
6. Paste the Home Assistant webhook URL and click **Save**.
7. Turn on the destination.
8. Click **Test**.

In Home Assistant, create an automation under **Settings → Automations & scenes** and add a webhook
trigger. Its webhook URL has this form:
