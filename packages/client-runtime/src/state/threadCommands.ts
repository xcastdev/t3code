...
import {
  ...
  type RestoreThreadHistoryInput,
  type ForkThreadHistoryInput,
...
export type {
  ...
  RestoreThreadHistoryInput,
  ForkThreadHistoryInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    restoreHistory: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:restore-history",
      execute: (input: RestoreThreadHistoryInput) => restoreThreadHistory(input),
      scheduler,
      concurrency,
    }),
    forkHistory: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:fork-history",
      execute: (input: ForkThreadHistoryInput) => forkThreadHistory(input),
      scheduler,
      concurrency,
    }),
