...
export class ProjectMcpNameConflictError extends Schema.TaggedError<ProjectMcpNameConflictError>()(
...
export class ProjectMcpEnvironmentVariableNameConflictError extends Schema.TaggedError<ProjectMcpEnvironmentVariableNameConflictError>()(
...
export class ProjectMcpProviderNotFoundError extends Schema.TaggedError<ProjectMcpProviderNotFoundError>()(
...
export class ProjectMcpServerLimitExceededError extends Schema.TaggedError<ProjectMcpServerLimitExceededError>()(
...
export class ProjectMcpServerNotFoundError extends Schema.TaggedError<ProjectMcpServerNotFoundError>()(
...
export class ProjectMcpOAuthActionError extends Schema.TaggedError<ProjectMcpOAuthActionError>()(
...
export class ProjectMcpCatalogCommittedCleanupPendingError extends Schema.TaggedError<ProjectMcpCatalogCommittedCleanupPendingError>()(
