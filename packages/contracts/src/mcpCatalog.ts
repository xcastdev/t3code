...
export class McpCatalogNameConflictError extends Schema.TaggedError<McpCatalogNameConflictError>()(
...
export class McpCatalogProviderLimitExceededError extends Schema.TaggedError<McpCatalogProviderLimitExceededError>()(
...
export class McpCatalogStaleRevisionError extends Schema.TaggedError<McpCatalogStaleRevisionError>()(
...
export class McpCatalogStaleSessionError extends Schema.TaggedError<McpCatalogStaleSessionError>()(
...
export class McpCatalogUnsupportedProviderError extends Schema.TaggedError<McpCatalogUnsupportedProviderError>()(
...
export class McpCatalogOperationError extends Schema.TaggedError<McpCatalogOperationError>()(
